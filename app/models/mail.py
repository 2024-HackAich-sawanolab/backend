...
class Mail(Base, TimestampMixin):
    ...
    mail_id = Column(String(1024), nullable=False, primary_key=True, server_default="ogrojojo332nk")
    ...
    your_mail_address = Column(String(1024), nullable=True, server_default="hogehoge@gmail.com")
